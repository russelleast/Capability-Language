...
title: Guides
description: Task-oriented DCL modelling guides.
---

# Guides

Guides answer "How do I..." questions. Each guide focuses on a modelling task or architectural pattern and includes DCL source that is compiled against the current compiler.
...
- [Write a first capability](/Capability-Language/guides/first-capability/)
- [Multi-file composition](/Capability-Language/guides/multi-file-composition/)
