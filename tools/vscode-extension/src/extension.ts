...
export function activate(context: vscode.ExtensionContext): void {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand("dcl.showCapabilityInfluenceGraph", () => openGraphWorkspace(context.extensionUri, diagnostics, summary, explorer, { graphType: "capability-influence" })),
