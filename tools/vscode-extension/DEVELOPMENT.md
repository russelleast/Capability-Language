...
9. Confirm the GitHub Release contains `dcl-vscode-extension-v1.0.6.vsix`.
...
13. Verify the extension version in VS Code is `1.0.6`.
14. Verify the website Marketplace and VSIX links.

The release tag convention is `vscode-extension-vX.Y.Z`, for example `vscode-extension-v1.0.6`. This keeps extension releases distinct from language, compiler, and website tags in the monorepo.
