...
exports.causeEffectLayoutPositions = causeEffectLayoutPositions;
const KIND_ORDER = [
    "intent",
    "capability",
    "rule",
...
function causeEffectLayoutPositions(graph) {
...
function layoutComponent(graph, component) {
...
function compareComponents(graph, left, right) {
...
function compareNodes(graph, leftId, rightId) {
